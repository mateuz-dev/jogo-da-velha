...
const vertical1 = [button1, button2, button3];
const vertical2 = [button4, button5, button6];
const vertical3 = [button7, button8, button9];
const horizontal1 = [button1, button4, button7];
const horizontal2 = [button2, button5, button8];
const horizontal3 = [button3, button6, button9];
